...
| v2.5.0 | 31 | tag `v2.5.0` | One-run destination selection |
...
v2.4.3 during the transparent publication repair, v2.4.4 as its tested successor, and v2.4.5 as v2.4.6's predecessor. v2.5.0 is the current release.
