...
2. Download `GDrive-Backup-Tiger-2.3.1.pkg` from `Assets`.
...
3. Scroll to `Security` and click `Open Anyway` for `GDrive-Backup-Tiger-2.3.1.pkg`.
...
```bash
xattr -d com.apple.quarantine "$HOME/Downloads/GDrive-Backup-Tiger-2.3.1.pkg"
```
